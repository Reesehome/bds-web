<template>
    <div id="dictionary" class="clearfix">
        <!-- 菜单目录 -->
        <aside class="systemConf-aside xs-w100">
            <i-card title="字典目录" icon="ios-cog">
                <i-tree :data="dictionaryTree" @on-select-change="selectNode"></i-tree>
            </i-card>
        </aside>
        <!-- 编辑区 -->
        <section class="systemConf-editor xs-w100">
            <i-card title="字典定义" icon="ios-cog">
                ...
                <!-- 二级菜单：已有的扩展属性列表 -->
                <div class="inner-card" v-show="dictionaryData.type==='D'">
                    <div class="card-head">已有的扩展属性列表</div>
                    <div class="card-body">
                        <!-- 功能按钮区 -->
                ...
                <!-- 三级菜单：多语言设置 -->
                <div class="inner-card" v-show="dictionaryData.type==='I'">
                    <div class="card-head">多语言设置</div>
                    <div class="card-body">
                ...
                <!-- 三级菜单：扩展属性配置 -->
                <div class="inner-card" v-show="dictionaryData.type==='I'">
                    <div class="card-head">扩展属性配置</div>
                    <div class="card-body">
                        <i-form :label-width="100">

<template>
    <div id="menuSettings" class="clearfix">
        <!-- 菜单目录 -->
        <aside class="systemConf-aside">
            <i-card title="菜单目录" icon="ios-cog">
                <i-tree :data="menuTree"></i-tree>
            </i-card>
        </aside>
        <!-- 属性编辑区 -->
        <section class="systemConf-editor xs-w100">
            <i-card title="属性编辑" icon="ios-cog">
                <i-button type="primary" slot="extra">保存</i-button>
                <!-- 基本属性 -->
                <div class="inner-card">
                    <p class="card-head">基本属性</p>
                    <div class="card-body">

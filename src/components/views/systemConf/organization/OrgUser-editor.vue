            ...
            <i-tabs size="small" type="card" :value="activeTab" @on-click="changeTab">
                <i-tab-pane label="基本信息" name="baseInfoTab">
                    ...
                    <div class="inner-card">
                        <p class="card-head">{{newUser?'新增基本属性':'修改基本属性'}}</p>
                        <div class="card-body">
                ...
                <i-tab-pane label="所在部门" name="departmentTab">
                    <!-- 所在部门 -->
                    <div class="inner-card">
                        <p class="card-head">{{newUser?'新增所在部门':'修改所在部门'}}</p>
                        <div class="card-body">
                ...
                <i-tab-pane label="操作权限" name="operateRightsTab">
                    ...
                    <div class="inner-card">
                        ...
                        <div class="card-body">
                            <i-row>
                                <i-col span="8" style="padding:0 16px" class="xs-w100">
                                    <div class="inner-card-tree">
                                        <h4>已拥有的权限组</h4>
                                        <i-tree :data="orgOwnedGroupTree"></i-tree>
                                    </div>
                                </i-col>
                                <i-col span="8" style="padding:0 16px" class="xs-w100">
                                    <div class="inner-card-tree">
                                ...
                                <i-col span="8" style="padding:0 16px" class="xs-w100">
                                    <div class="inner-card-tree">
                                        <h4>分配单独权限</h4>
                                        <i-tree :data="orgMenuRightsByUser" show-checkbox></i-tree>
                                    </div>
                                </i-col>
                            </i-row>
                        </div>
                ...
                <i-tab-pane label="数据权限" :disabled="newUser" name="dataRightsTab">
                    ...
                    <div class="inner-card">
                        ...
                        <div class="card-body">
                            <div class="inner-card-tree" style="width:45%">
                                <h4>权限目录</h4>
